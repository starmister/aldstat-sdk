 ...
 */
@Slf4j
public class AldFastBatchConsumer implements Consumer {
    ...
    public AldFastBatchConsumer(@NonNull String appKey,boolean debug, @NonNull Callback callback) {
        this(appKey,debug, false, callback);
    }

    public AldFastBatchConsumer(@NonNull String appKey,boolean debug, int flushSec, final boolean timing, @NonNull Callback callback) {
        this(appKey,debug, timing, 50, 6000, flushSec, 3, callback);
    }

    public AldFastBatchConsumer(@NonNull String appKey,boolean debug, final boolean timing, @NonNull Callback callback) {
        this(appKey,debug, timing, 50, callback);
    }

    public AldFastBatchConsumer(@NonNull String appKey,boolean debug, final boolean timing, int bulkSize, @NonNull Callback callback) {
        this(appKey,debug, timing, bulkSize, 6000, callback);
    }

    public AldFastBatchConsumer(@NonNull String appKey,boolean debug, final boolean timing, int bulkSize, int maxCacheSize,
                             @NonNull Callback callback) {
        this(appKey,debug, timing, bulkSize, maxCacheSize, 1, 3, callback);
    }

    public AldFastBatchConsumer(@NonNull String appKey,boolean debug, final boolean timing, final int bulkSize, int maxCacheSize,
        ...
        log.info(
                "Initialize AldFastBatchConsumer with params:[timing:{};bulkSize:{};maxCacheSize:{};flushSec:{};timeoutSec:{}].",
